...
$(function () {
    ...
    $(".datepicker, .datetimepicker, #from_date, #to_date").keydown(function(e){
      e.preventDefault();
    });
    $(".datepicker, .datetimepicker, #from_date, #to_date").attr("autocomplete","off");
        ...
        '<div class="modal-dialog">'+
            '<div class="modal-content">'+
                ...
                '<div class="modal-footer">'+
                    '<a href="'+url+'" class="btn btn-success btn-flat">Yes</a>'+
    ...
    $('<div class="modal fade" id="myModal" role="dialog">'+
        '<div class="modal-dialog">'+
            '<div class="modal-content">'+
                ...
                '<div class="modal-footer">'+
                    '<a href="'+url+'" class="btn btn-success btn-flat">Yes</a>'+
                    '<button type="button" class="btn btn-danger btn-flat" data-dismiss="modal" onclick="dismissModal()">No</button>'+
                '</div>'+
            '</div>'+
      '</div>'+
    '</div>').modal();
    ...
    for (var i=0; i<rowCount; i++) {
        ...
        if (null != chkbox && true == chkbox.checked) {
            ...
            if (rowCount>1) {
                ...
                alert('You Can Not Remove All row!');
            }
            checkRow++;
        }
    }
