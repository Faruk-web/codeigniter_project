...
$config['rest_instance_column'] = 'user_id';
...
$config['rest_instance_name_length'] = 20;
...
|
*/
$config['rest_key_name'] = 'INSTANCE-API-SECRETE';
$config['rest_instance_name'] = 'INSTANCE-NAME';
...
|       `hour_started` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
|       `api_key` VARCHAR(40) NOT NULL,
|       PRIMARY KEY (`id`)
|   ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
|
