    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            ...
            if (isset($edit) || isset($create)) {
                if (isset($dataview)) {
                    $expense_number = $dataview->expense_number;
                    $expense_date = $dataview->expense_date;
                    $expense_note = $dataview->expense_note;
                    $expense_amount = $dataview->expense_amount;
                } else {
                    $expense_number = '';
                    $expense_date = set_value('expense_date');
                    $expense_note = set_value('expense_note');
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?php echo $expense_number; ?>" placeholder="Auto Generated" readonly>
                            </div>
                        </div>

                        <div class="form-group <?php echo (form_error('expense_date')!='')?'has-error has-danger':''; ?>">
                            <label class="control-label col-sm-3 required">Date</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control datepicker" name="expense_date" value="<?php echo $expense_date; ?>" required>
                            </div>
                            <?php echo form_error('expense_date'); ?>
                        </div>

                        <div class="form-group <?php echo (form_error('expense_note')!='')?'has-error has-danger':''; ?>">
                            <label class="control-label col-sm-3 required">Note</label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" name="expense_note" rows="4"><?php echo $expense_note?></textarea>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                    ...
                                    <th><input type="text" class="form-control readonly" name="expense_amount" id="expense_amount" value="<?php echo $expense_amount?>" required></th>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <table class="table table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $val->expense_number; ?></td>
                                <td><?php echo dateFormat($val->expense_date); ?></td>
                                <td>
                                    <?php
