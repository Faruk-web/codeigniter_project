    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            ...
            if (isset($edit) || isset($create)) {
                if (isset($dataview)) {
                    $head_name = $dataview->head_name;
                    $status = $dataview->status;
                } else {
                    $head_name = set_value('head_name');
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    ...
                    <div class="col-md-8">
                        <div class="form-group <?php echo (form_error('head_name')!='')?'has-error has-danger':''; ?>">
